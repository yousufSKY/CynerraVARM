        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-6 sm:px-8 md:px-12 xl:px-20 py-8">
          <div className="max-w-md xl:max-w-lg">
            ...
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 lg:mb-6 leading-tight">
              Start Your
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600"> Security Journey</span>
            </h1>
            ...
            <div className="space-y-3 lg:space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm lg:text-base text-gray-300">Free 14-day trial - no credit card required</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center">
                  <Shield className="h-4 w-4 text-cyan-400" />
                </div>
                <span className="text-sm lg:text-base text-gray-300">Comprehensive vulnerability scanning</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-8 h-8 bg-blue-500/20 rounded-full flex items-center justify-center">
                  <Lock className="h-4 w-4 text-blue-400" />
                </div>
                <span className="text-sm lg:text-base text-gray-300">24/7 threat monitoring & alerts</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 w-8 h-8 bg-teal-500/20 rounded-full flex items-center justify-center">
                  <Users className="h-4 w-4 text-teal-400" />
                </div>
                <span className="text-sm lg:text-base text-gray-300">Expert security team support</span>
              </div>
            </div>
            ...
            <div className="mt-8 lg:mt-12 pt-6 lg:pt-8 border-t border-blue-900/30">
              <div className="flex items-center space-x-4 mb-3 lg:mb-4">
                <div className="flex -space-x-2">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full border-2 border-[#1a1a2e]"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-teal-400 to-cyan-500 rounded-full border-2 border-[#1a1a2e]"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-blue-400 to-teal-500 rounded-full border-2 border-[#1a1a2e]"></div>
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-[#1a1a2e] rounded-full border-2 border-cyan-400 flex items-center justify-center">
                    <span className="text-xs text-cyan-400 font-bold">500+</span>
                  </div>
                </div>
                <span className="text-gray-400 text-sm">Organizations protected</span>
              </div>
              <div className="flex flex-wrap items-center gap-2 lg:gap-4">
                <div className="bg-blue-500/10 px-2 lg:px-3 py-1 rounded-full border border-blue-500/20">
                  <span className="text-xs text-blue-400 font-medium">Enterprise Ready</span>
                </div>
